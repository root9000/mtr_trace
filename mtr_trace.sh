echo -e "\n该小工具可以为你检查本服务器到中国安徽的[回程网络]类型\n"
read -p "按Enter(回车)开始启动检查..." sdad

iplise=(60.170.202.1 58.242.160.1 120.209.28.1 117.65.108.1 36.32.130.1 112.31.144.1 218.22.21.25 218.104.71.168 202.141.176.6)
iplocal=(安徽电信A 安徽联通A 安徽移动A 安徽电信B 安徽联通B 安徽移动B 中科大电信 中科大联通 中科大移动)
echo "开始安装mtr命令..."
